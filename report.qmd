...
In order to predict test score from our variables of interest, we decided to use backwards, forwards, and stepwise regression using Aikake's Information Criteria (AIC) as the criteria. Each of the three methods selected the same results for each outcome. 
